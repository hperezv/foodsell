      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open('admin/tipodoc', $attributes);
            ...
            <tbody>
              ...
              foreach($manufacturers as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/tipodoc/update/'.$row['id'].'" class="btn btn-info">Editar</a>  
                  <a href="'.site_url("admin").'/tipodoc/delete/'.$row['id'].'" class="btn btn-danger">Borrar</a>
                </td>';
                echo '</tr>';
              }
              ?>      
